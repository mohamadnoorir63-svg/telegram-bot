...
# 🔒 تعریف قفل‌ها (قبل از register_group)
LOCK_MAP = {
...
def register_group(gid):
    ...
    if gid not in data["stats"]:
        data["stats"][gid] = {
            ...
            "users": {},
            "counts": {
                "msg": 0, "photo": 0, "video": 0, "voice": 0,
                "music": 0, "sticker": 0, "gif": 0, "fwd": 0
            }
        }
    save_data(data)
...
# ================= 🚀 اجرای ربات =================
print("🤖 ربات مدیریتی v11.1 Pro با موفقیت فعال شد!")
