# ====================== 🌟 پنل مدیریت ربات (نسخه نهایی کامل با قفل گروه + رمضان + ساخت ریپلای) ======================
...
FUN_TEXTS = {
    ...
    "fun_reply": ("💾 ساخت ریپلای", "با دستور /save روی پیام ریپلای کن تا ذخیره بشه و با /reply دوباره ارسالش کن 💬"),
}
