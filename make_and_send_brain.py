...
def build_brain(n=50000):
    print("🧠 در حال ساخت مغز… کمی صبر کن.")
    phrases = {}
    for i in range(n):
...
async def send_zip(path: str):
    ...
    await bot.send_document(
        ...
        caption="🧠 مغز خِنگول آماده‌ست! این ZIP رو مستقیماً برای ربات بفرست و /restore بزن.",
    )
    print("📨 فایل برای سودو ارسال شد.")

if __name__ == "__main__":
    zip_path, size = build_brain(n=50000)  # اگر ارور مموری داشتی 20000 بذار
    if size < 2000:
        print("⚠️ ZIP خیلی کوچک است؛ احتمالا ساخت خراب شده.")
    else:
