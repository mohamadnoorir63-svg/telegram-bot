...
def generate_digi_fonts(name):
    ...
    first_page_fonts = [style.format(*([name]*style.count("{}"))) for style in first_page_styles]

    # ---------------- فونت‌های اضافی برای صفحات بعد ----------------
    additional_styles = [
        "{}ღ{}ღ{}",
        "{}❖{}❖{}",
        "⚡{}⚡{}⚡{}",
    ...
    additional_fonts = [style.format(*([name]*style.count("{}"))) for style in additional_styles]
    ...
    english_fonts.append(spaced_flag)  # 🇹 🇪 🇸 🇹 شبیه سازی با حروف کاربر
    ...
    # ---------------- ترکیب همه فونت‌ها ----------------
    all_fonts = first_page_fonts + additional_fonts + english_fonts
