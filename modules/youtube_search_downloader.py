# youtube_search_downloader.py — ULTRA TURBO v3
...
async def youtube_quality_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # --------------------------------
    if choice == "yt_audio":
        await cq.edit_message_text("⬇ در حال دانلود صوت (Turbo-MP3)...")
    ...
    if choice.startswith("v_"):
        ...
        await cq.edit_message_text(
            f"⬇ در حال دانلود کیفیت {quality_label} (Ultra-Turbo)..."
        )
