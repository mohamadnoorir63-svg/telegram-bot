...
COOKIE_FILE = "modules/youtube_cookie.txt"   # ← کوکی یوتیوب
executor = ThreadPoolExecutor(max_workers=8)  # سرعت بسیار بالا
track_store = {}
...
# ================================
# جستجو → SoundCloud → (fallback) YouTube
# ================================
