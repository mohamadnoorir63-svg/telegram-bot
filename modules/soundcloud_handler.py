...
# ================================
def _super_fast_mp3_sync(url: str):
    opts = BASE_OPTS.copy()

    # 🔥 تنظیمات آتشی مخصوص سرعت
    opts.update({
        "quiet": True,
        "noplaylist": True,
        "overwrites": True,
        ...
        # 🚀 حداکثر سرعت دانلود قطعه‌ها
        "concurrent_fragment_downloads": 32,
        "fragment_retries": 15,
        "retries": 15,
        "file_access_retries": 10,

        # همیشــه خروجی MP3 با کیفیت 192
        "postprocessors": [
            {
...
def _tidal_fallback_sync(query: str):
    ...
    opts.update({
        ...
        "overwrites": True,
        "cachedir": False,
        "concurrent_fragment_downloads": 32,  # 🚀 سرعت آتشین
        "fragment_retries": 15,
        "retries": 15,
        "file_access_retries": 10,
        "nocheckcertificate": True,
...
def _youtube_fallback_sync(query: str):
    ...
    opts.update({
        ...
        "noplaylist": True,
        "cachedir": False,
        "concurrent_fragment_downloads": 32,  # 🔥 ۲ برابر سرعت نسخه قبلی
        "fragment_retries": 20,
        "retries": 20,
